...
![](http://www.tailsfromthefield.net/wp-content/uploads/2014/07/5.VectorRaster.png){fig-alt="Vector-Raster" fig-align="center"}
...
::: {.column width="50%"}
![](https://geocompr.robinlovelace.net/figures/sf-classes.png){fig-alt="Simple Features" fig-width="600px" fig-align="center"}^[Geocomputation with R, fig 2.2: <https://geocompr.robinlovelace.net>]
:::
::::
