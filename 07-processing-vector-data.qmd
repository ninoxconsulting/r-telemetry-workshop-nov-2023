...
Moving windows or focal calculations estimate a new value for each pixel based on the values of the surrounding pixels (neighbours) and the function we supply. In this example we will use a window or 9, and a calculation based on the sum of these 9 pixels.
