...
References: - [Movebank](https://www.movebank.org/cms/movebank-main). - [move2 r package vignette - "Downloading data from movebank"](https://cran.r-project.org/web/packages/move2/vignettes/movebank.html)
